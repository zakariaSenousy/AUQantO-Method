...
if args.network == '2':
    ...
    file = open(r'G:/Automated HybridLSTM (Skin) - entropy/ReportsT_F5/Test_F5_all_methods_extended.txt', 'w')

    BetasF1 = [0.235, 0.1975, 0.2347, 0.0014, 2.5]
    BetasF2 = [0.0708, 0.213, 0.267, 0.0043, 2.5]
    BetasF3 = [0.0707, 0.0705, 0.074, 0.0727, 2.5]
    BetasF4 = [0.2867, 0.29125, 0.2938, 0.0023, 2.5]
    BetasF5 = [0.3019, 0.2014, 0.2904, 0.0409, 2.5]
