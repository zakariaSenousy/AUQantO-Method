...
LABELS = ['Normal', 'AdenoCarcinoma', 'Large_Cell_Carcinoma', 'Squamous_Cell_Carcinoma']
LabelAbbrev = ['N', 'ADC', 'LCC', 'SCC']
...
if args.network == '2':
    ...
    for i in trials:
        file = open(r'G:/Automated HybridLSTM (Lung)/ReportsT_'+Test_Fold+'/NSGA2/ExcImgs_T'+Test_Fold+'_V'+valid_Fold+'_NSGA2_trial'+str(i)+'.txt', 'w')
