...
if args.network == '2':
    ...
    file = open(r'G:/Automated Deep spatial Fusion (BACH) - Entropy/ReportsT_F1/Test_F1_all_methods_extended.txt', 'w')

    BetasF1 = [0.2933, 0.291, 0.3008, 0.0224, 2.5]
    BetasF2 = [0.04266, 0.76, 0.6523, 0.00634, 2.5]
    BetasF3 = [0.48308, 0.51, 0.4915, 0.00833, 2.5]
    BetasF4 = [0.4452, 0.51, 0.5255, 0.0204, 2.5]
    BetasF5 = [0.06977, 0.0725, 0.0546, 0.044, 2.5]
