...
if args.network == '2':
    ...
    file = open(r'G:/Automated Deep spatial Fusion (BACH) - MC/ReportsT_F5/Test_F5_all_methods_extended.txt', 'w')

    BetasF1 = [0.0457775, 0.10375, 0.08743, 0.105603, 2.5]
    BetasF2 = [0.0588497, 0.150625, 0.1036968, 0.083277, 2.5]
    BetasF3 = [0.063889, 0.10375, 0.0783644, 0.04383, 2.5]
    BetasF4 = [0.052169, 0.135, 0.12272, 0.0573, 2.5]
    BetasF5 = [0.05508, 0.056875, 0.05106, 0.07277, 2.5]
