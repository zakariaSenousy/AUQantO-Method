...
if args.network == '2':
    ...
    file = open(r'G:/Automated Deep spatial Fusion (Skin) - MC/ReportsT_F5/Test_F5_all_methods_extended.txt', 'w')

    BetasF1 = [0.224607, 0.1975, 0.197145, 0.11728, 2.5]
    BetasF2 = [0.137033, 0.17406, 0.168555, 0.107513, 2.5]
    BetasF3 = [0.1971706, 0.3225, 0.26543, 0.14639, 2.5]
    BetasF4 = [0.27336, 0.27172, 0.244087, 0.114233, 2.5]
    BetasF5 = [0.1761944, 0.295156, 0.261874, 0.20946, 2.5]
