...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--Vfold', type=str, default='0', help='Decide the fold for validation')
        parser.add_argument('--Tfold', type=str, default='0', help='Decide the fold for testing')
